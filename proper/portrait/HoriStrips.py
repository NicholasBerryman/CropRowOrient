...
for part in imageParts:
        ...
        for contour in contours:
                ...
                if (abs(potentialRow - cy) < plantWindowHeight): #TODO check distance (this is not d2 - not quite sure what it should be)
...
for contour in allContours:
        ...
        #        rowXs.append(coord[0][0])
        #        rowYs.append(coord[0][1])
        cx, cy = getContCentre(contour)
        rowXs.append(cx)
        rowYs.append(cy)
